...
- **2.5** [ ] טבלת `user_settings` (ליעד חודשי מסונכרן — עתידי)
- **2.6** [ ] טבלת `playbooks` (עתידי)
...
- **5.1** [x] יעד חודשי + פס התקדמות
  - 5.1.1 [ ] סנכרון היעד בין מכשירים (כרגע localStorage)
...
- **9.1** [ ] פלייבוק/אסטרטגיות (מודול + טבלה)
- **9.2** [ ] סנכרון היעד החודשי בענן
- **9.3** [ ] מצב כהה
- **9.4** [ ] Heatmap + מסננים באנליטיקה
- **9.5** [ ] דומיין אישי
