...
- **2.5** [x] טבלת `user_settings` (JSONB) — `sql/0004_user_settings.sql` ⚠️ *להריץ ב-Supabase*
- **2.6** [x] טבלת `playbooks` — `sql/0005_playbooks.sql` ⚠️ *להריץ ב-Supabase*
...
- **9.1** [ ] מצב כהה
- **9.2** [ ] Heatmap + מסננים באנליטיקה
- **9.3** [ ] קישור עסקאות לפלייבוק
- **9.4** [ ] דומיין אישי
